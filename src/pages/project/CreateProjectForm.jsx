            ...
            <form className='space-y-5' onSubmit = {form.handleSubmit(onSubmit)}>
                ...
                render = {({field})=> <FormItem>
                    <FormControl>
                        <Input {...field}
                        type="text"
                        className="border w-full border-gray-700 py-r px-5"
                    ...
                    <div className='flex gap-1 flex-wrap'>
                      {
                        ...
                        <span className='text-em'>{item}</span>
                ...
                <DialogClose>
                    {false? <div>
                        <p>You can create only 3 projects with free plan, please upgrade your plan to create more projects</p>
                    </div>: <Button type="submit" className="w-full mt-5">
